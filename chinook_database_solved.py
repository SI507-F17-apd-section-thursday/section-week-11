...
execute_and_print('select "Name", "AlbumId" from "Track"')
...
execute_and_print(""" select avg("Milliseconds") from "Track" """)

# AVG in minutes
print('==> Get average playtime in minutes of all tracks')
execute_and_print(""" select avg("Milliseconds") / 60000.0 as "Minutes" from "Track" """)
